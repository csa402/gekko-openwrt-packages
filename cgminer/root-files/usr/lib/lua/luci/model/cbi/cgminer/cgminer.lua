...
cf1 = conf:option(Value, "cf1", translate("compac Chip Frequency(Range: 100-250, Default: 100)"))
cf1.default = "100"
cf1.datatype = "range(100, 300)"

cf2 = conf:option(Value, "cf2", translate("2pac Chip Frequency(Range: 100-500, Default: 150)"))
cf2.default = "150"
